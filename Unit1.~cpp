...
void countMatches(int secret, int guess, int& correctDigits, string& correctPositions) {
    ...
    while (secretCopy > 0 && guessCopy > 0) {
        ...
        if (secretDigit == guessDigit) {
            correctDigits++;
            // Преобразование цифры в строку без использования to_string
...
// Получаем число из Edit1
    ...
    if (i<=9)
    {
    // Проверяем, находится ли число в диапазоне от 1 до 1000
    ...
    {
        Memo2->Lines->Add("Поздравляем! Вы угадали число!");
    }
    }
    }
//---------------------------------------------------------------------------
